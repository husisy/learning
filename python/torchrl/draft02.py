...
# x0: tensordict
#   done: (torch, bool, (1,))
#   observation: (torch, float32, (11,))
#   step_count: (torch, int64, (1,))
#   terminated: (torch, bool, (1,))
#   truncated: (torch, bool, (1,))
policy_module(x0) #in-place update x0
#  action: (torch, float32, (1))
#  loc: (torch, float32, (1))
#  scale: (torch, float32, (1))
#  sample_log_prob: (torch, float32, (1))
value_module(x0) #in-place update x0
#  state_value: (torch, float32, (1))
...
advantage_module = torchrl.objectives.value.GAE(gamma=0.99, lmbda=0.95, value_network=value_module, average_gae=True)
