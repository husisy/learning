...
paramiko.util.log_to_file(hf_file('paramiko-ssh-server.log'))
...
class Server(paramiko.ServerInterface):
    ...
    good_pub_key = paramiko.RSAKey(data=paramiko.py3compat.decodebytes(data))
    ...
    def check_auth_publickey(self, username, key):
        print("Auth attempt with key: " + paramiko.py3compat.u(hexlify(key.get_fingerprint())))
