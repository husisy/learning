...
class AccMonitor(ms.train.callback.Callback):
    def __init__(self, model, ds_val):
    ...
    def epoch_end(self, run_context):
        tmp0 = self.model.eval(self.ds_val, dataset_sink_mode=True)['top1']
...
# TODO test ms.nn.metrics.Accuracy, see doc
...
print('ds_val256:', model.eval(ds_val256, dataset_sink_mode=True)) #TODO error
